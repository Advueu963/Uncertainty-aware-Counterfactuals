...
if __name__ == "__main__":
    ...
    for dataset_name in data_files:
        ...
        # print("Class probabilities: ", orig_prob)
        # print("Class weights for loss: ", loss_weights)
        # # Use the inverse of the class frequency as weights
        # weights = len(y_train) / (len(np.unique(y_train)) * np.bincount(y_train))
        # weights = None
